...
export default function Dashboard() {
  ...
  // ── Organ distribution (excludes Benign — filtered in backend) ──
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 28, alignItems: "center", flexWrap: "wrap" }}>
        ...
        {selectedYear && (
          <select
            ...
            onChange={e => {
              ...
              setSelectedMonth(mo);
              setPeriod(mo ? `${selectedYear}-${mo}` : selectedYear);
            }}
            style={{
              padding: "8px 32px 8px 14px", borderRadius: 9, fontSize: 13, fontWeight: 600,
        ...
        {loading && (
          <span style={{ fontSize: 12, color: "#94a3b8", marginLeft: 4 }}>Updating…</span>
        )}
      </div>
      ...
      <div style={{ display: "flex", gap: 20, flexWrap: "wrap" }}>
        <CaseDistributionChart data={caseData.length > 0 ? caseData : undefined} />
